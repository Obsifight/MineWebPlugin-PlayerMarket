...
import fr.thisismac.injector.customclass.BlockSmallFence;
import fr.thisismac.injector.customclass.BlockStainedSand;
import fr.thisismac.injector.customclass.BlockStoneBrickStained;
...
import fr.thisismac.injector.customclass.BoneBlock;
import fr.thisismac.injector.customclass.CustomBlockInvisible;
import fr.thisismac.injector.customclass.CustomChest;
import fr.thisismac.injector.customclass.CustomStuff.StuffPart;
import fr.thisismac.injector.customclass.StainedSandstone;
...
public class Block
{
    ...
    public static void registerBlocks()
    {
      ...
      blockRegistry.addObject(159, "stained_hardened_clay", (new BlockColored(Material.rock)).setHardness(1.25F).setResistance(7.0F).setStepSound(soundTypePiston).setBlockName("clayHardenedStained").setBlockTextureName("hardened_clay_stained"));
         ...
         * OBSIFIGHT
         */
        blockRegistry.addObject(176, "renforced_wood", new Block(Material.anvil).setBlockName("renforced_wood").setBlockTextureName("renforced_wood").setHardness(5.0F).setStepSound(Block.soundTypeWood).setCreativeTab(CreativeTabs.tabBlock).setResistance(10.0F));
blockRegistry.addObject(177, "renforced_stone", new Block(Material.anvil).setBlockName("renforced_stone").setBlockTextureName("renforced_stone").setHardness(5.0F).setStepSound(Block.soundTypeStone).setCreativeTab(CreativeTabs.tabBlock).setResistance(10.0F));
blockRegistry.addObject(178, "renforced_brick", new Block(Material.anvil).setBlockName("renforced_brick").setBlockTextureName("renforced_brick").setHardness(5.0F).setStepSound(Block.soundTypeStone).setCreativeTab(CreativeTabs.tabBlock).setResistance(10.0F));
blockRegistry.addObject(179, "chest_garnet", new CustomChest(2, "textures/entity/chest/tg.png").setBlockName("chest_garnet").setHardness(2.5F));
blockRegistry.addObject(180, "chest_amethyst", new CustomChest(3, "textures/entity/chest/chest_amethyste.png").setBlockName("chest_amethyst").setHardness(2.5F));
blockRegistry.addObject(181, "chest_titanium", new CustomChest(4, "textures/entity/chest/chest_titanium.png").setBlockName("chest_titanium").setHardness(2.5F));
blockRegistry.addObject(182, "chest_xenotium", new CustomChest(5, "textures/entity/chest/chest_xenotium.png").setBlockName("chest_xenotium").setHardness(2.5F));
blockRegistry.addObject(183, "invisible_block", new CustomBlockInvisible(Material.glass, false).setHardness(10F).setBlockName("invisible_block").setBlockTextureName("invisible").setCreativeTab(CreativeTabs.tabBlock).setStepSound(Block.soundTypeGlass));
blockRegistry.addObject(184, "invisible_block_light", new CustomBlockInvisible(Material.glass, false).setHardness(10F).setBlockName("invisible_block_light").setBlockTextureName("invisible").setCreativeTab(CreativeTabs.tabBlock).setLightLevel(1F).setStepSound(Block.soundTypeGlass));		
blockRegistry.addObject(185, "copper_ore", new BlockOre().setHardness(3.0F).setResistance(5.0F).setStepSound(Block.soundTypePiston).setBlockName("copper_ore").setBlockTextureName("copper_ore"));
blockRegistry.addObject(186, "stone_andesite", new Block(Material.rock).setBlockName("stone_andesite").setHardness(2F).setBlockTextureName("stone_andesite").setStepSound(Block.soundTypeStone).setCreativeTab(CreativeTabs.tabBlock));
...
blockRegistry.addObject(188, "xtnt", new BlockXTNT().setHardness(0.0F).setStepSound(Block.soundTypeGrass).setBlockName("xtnt").setBlockTextureName("xeno_tnt"));
blockRegistry.addObject(189,"iron_ladder", (new BlockLadder()).setHardness(0.4F).setStepSound(Block.soundTypeLadder).setBlockName("iron_ladder").setBlockTextureName("iron_ladder"));
blockRegistry.addObject(190, "weed", (new BlockWeed()).setBlockName("weed").setBlockTextureName("weed"));
blockRegistry.addObject(191, "renforced_glass", (new BlockRenforcedGlass(Material.anvil, true)).setBlockName("renforced_glass").setBlockTextureName("renforced_glass").setStepSound(Block.soundTypeGlass));
...
Block var9a = (new Block(Material.rock)).setStepSound(Block.soundTypePiston).setHardness(0.8F).setBlockName("quartzNoir").setBlockTextureName("burnt_quartz").setCreativeTab(CreativeTabs.tabBlock);
...
blockRegistry.addObject(202, "chest_event_anvil", new CustomChest(6, "textures/entity/chest/chest_anvil.png").setBlockName("chest_anvil").setHardness(2.5F));
blockRegistry.addObject(203, "chest_event_feuille", new CustomChest(7, "textures/entity/chest/chest_feuille.png").setBlockName("chest_feuille").setHardness(2.5F));
blockRegistry.addObject(204, "chest_event_tntrun", new CustomChest(8, "textures/entity/chest/chest_tntrun.png").setBlockName("chest_tntrun").setHardness(2.5F));
blockRegistry.addObject(205, "chest_event_spleef", new CustomChest(9, "textures/entity/chest/chest_spleef.png").setBlockName("chest_spleef").setHardness(2.5F));
blockRegistry.addObject(206, "chest_event_bowspleef", new CustomChest(10, "textures/entity/chest/chest_bowspleef.png").setBlockName("chest_bowspleef").setHardness(2.5F));
blockRegistry.addObject(207, "chest_event_chunckwars", new CustomChest(11, "textures/entity/chest/chest_chunck_wars.png").setBlockName("chest_chunckwars").setHardness(2.5F));
blockRegistry.addObject(208, "chest_event_xenoknock", new CustomChest(12, "textures/entity/chest/chest_xenoknock.png").setBlockName("chest_xenoknock").setHardness(2.5F));
blockRegistry.addObject(209, "chest_event_tournois", new CustomChest(13, "textures/entity/chest/chest_tournoi_pvp.png").setBlockName("chest_tournoipvp").setHardness(2.5F));
blockRegistry.addObject(210, "chest_event_arrow", new CustomChest(14, "textures/entity/chest/chest_arrow.png").setBlockName("chest_arrow").setHardness(2.5F));
...
blockRegistry.addObject(214, "netherwart_block", (new Block(Material.rock)).setBlockName("netherwart_block").setBlockTextureName("netherwart_block").setHardness(2.0F).setResistance(3.0F).setCreativeTab(CreativeTabs.tabBlock).setStepSound(Block.soundTypeWood));
blockRegistry.addObject(215, "red_netherbrick",(new Block(Material.rock)).setBlockName("red_netherbrick").setBlockTextureName("rednether_brick").setCreativeTab(CreativeTabs.tabBlock).setStepSound(Block.soundTypeStone).setHardness(6.0F).setResistance(7.0F));
...
blockRegistry.addObject(219, "hardened_stairs_" + ItemDye.field_150922_c[0], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 0).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[0]));
blockRegistry.addObject(220, "hardened_stairs_" + ItemDye.field_150922_c[1], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 1).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[1]));
blockRegistry.addObject(221, "hardened_stairs_" + ItemDye.field_150922_c[2], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 2).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[2]));
blockRegistry.addObject(222, "hardened_stairs_" + ItemDye.field_150922_c[3], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 3).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[3]));
blockRegistry.addObject(223, "hardened_stairs_" + ItemDye.field_150922_c[4], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 4).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[4]));
blockRegistry.addObject(224, "hardened_stairs_" + ItemDye.field_150922_c[5], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 5).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[5]));
blockRegistry.addObject(225, "hardened_stairs_" + ItemDye.field_150922_c[6], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 6).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[6]));
blockRegistry.addObject(226, "hardened_stairs_" + ItemDye.field_150922_c[7], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 7).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[7]));
blockRegistry.addObject(227, "hardened_stairs_" + ItemDye.field_150922_c[8], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 8).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[8]));
blockRegistry.addObject(228, "hardened_stairs_" + ItemDye.field_150922_c[9], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 9).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[9]));
blockRegistry.addObject(229, "hardened_stairs_" + ItemDye.field_150922_c[10], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 10).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[10]));
blockRegistry.addObject(230, "hardened_stairs_" + ItemDye.field_150922_c[11], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 11).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[11]));
blockRegistry.addObject(231, "hardened_stairs_" + ItemDye.field_150922_c[12], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 12).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[12]));
blockRegistry.addObject(232, "hardened_stairs_" + ItemDye.field_150922_c[13], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 13).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[13]));
blockRegistry.addObject(233, "hardened_stairs_" + ItemDye.field_150922_c[14], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 14).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[14]));
blockRegistry.addObject(234, "hardened_stairs_" + ItemDye.field_150922_c[15], new BlockStairs((Block)Block.getBlockFromName("stained_hardened_clay"), 15).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[15]));
