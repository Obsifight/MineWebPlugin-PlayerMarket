...
import fr.thisismac.injector.customclass.ItemKey;
...
public class Item
{
    ...
    public static void registerItems()
    {
       ...
       // itemRegistry.addObject(428, "coin_1", new Item().setTextureName("coin_1").setUnlocalizedName("coin_1").setCreativeTab(CreativeTabs.tabMaterials));
        		//itemRegistry.addObject("admin_axe", new ItemSimpleFoiled().setTextureName("admin_axe").setUnlocalizedName("admin_axe").setCreativeTab(CreativeTabs.tabTools)); rien
        ...
        itemRegistry.addObject(442, "joint", (new ItemJoint(0, 0F, false)).setAlwaysEdible().setTextureName("joint").setUnlocalizedName("joint").setCreativeTab(CreativeTabs.tabMisc));
        ...
        itemRegistry.addObject(445, "cookie_garnet", (new ItemCookieGarnet(0, 0F, false)).setAlwaysEdible().setUnlocalizedName("cookie_garnet").setTextureName("cookie_garnet"));
        itemRegistry.addObject(446, "cookie_amethyste", (new ItemCookieAmethyste(0, 0F, false)).setUnlocalizedName("cookie_amethyste").setTextureName("cookie_amethyste"));
        itemRegistry.addObject(447, "cookie_titanium", (new ItemCookieTitanium(0, 0F, false)).setUnlocalizedName("cookie_titanium").setTextureName("cookie_titanium"));
        itemRegistry.addObject(448, "cookie_obsidian", (new ItemCookieObsidian(0,0F,false)).setUnlocalizedName("cookie_obsidian").setTextureName("cookie_obsidian"));
  ...
  /*      itemRegistry.addObject(489, "sword_xenotium", (new ItemSword(Item.ToolMaterial.XENOTIUM)).setUnlocalizedName("sword_xenotium").setTextureName("xenotium_sword"));
        itemRegistry.addObject(490, "shovel_xenotium", (new ItemSpade(Item.ToolMaterial.XENOTIUM)).setUnlocalizedName("shovel_xenotium").setTextureName("xenotium_shovel"));
        itemRegistry.addObject(491, "pickaxe_xenotium", (new ItemPickaxe(Item.ToolMaterial.XENOTIUM)).setUnlocalizedName("pickaxe_xenotium").setTextureName("xenotium_pickaxe"));
        itemRegistry.addObject(492, "axe_xenotium", (new ItemAxe(Item.ToolMaterial.XENOTIUM)).setUnlocalizedName("axe_xenotium").setTextureName("xenotium_axe"));
     */   
      ...
      //  itemRegistry.addObject(504, "hoe_xenotium", (new ItemHoe(Item.ToolMaterial.XENOTIUM)).setUnlocalizedName("hoe_xenotium").setTextureName("xenotium_hoe"));
        ...
        itemRegistry.addObject(507, "bow_garnet", (new CustomBow(2, 1000, false).setUnlocalizedName("bow_garnet").setTextureName("garnet_bow")));
        itemRegistry.addObject(508, "bow_amethyst", (new CustomBow(3, 2000, false).setUnlocalizedName("bow_amethyst").setTextureName("amethyst_bow")));
        itemRegistry.addObject(509, "bow_titanium", (new CustomBow(4, 3000, false).setUnlocalizedName("bow_titanium").setTextureName("titanium_bow")));
      //  itemRegistry.addObject(510, "bow_xenotium", (new CustomBow(5, 4000, false).setUnlocalizedName("bow_xenotium").setTextureName("xenotium_bow")));
        itemRegistry.addObject(511, "bow_obsidium", (new CustomBow(6, 5000, false).setUnlocalizedName("bow_obsidium").setTextureName("obsidium_bow")));
        itemRegistry.addObject(512, "bow_manganese", (new CustomBow(1, 500, false).setUnlocalizedName("bow_manganese").setTextureName("manganese_bow")));
        
        itemRegistry.addObject(513, "key_event", (new ItemKey()));
        ...
        while (var2.hasNext())
        {
            ...
            else if  (var4 == Block.getBlockById(202))//sandstone coloré
            {
            	var5 = (new ItemCloth(Block.getBlockById(202))).setUnlocalizedName("sandstoneStained");
            }
            else if  (var4 == Block.getBlockById(218)) //sable coloré
            {
    ...
    {
        WOOD("WOOD", 0, 0, 59, 1.0F, 0.0F, 15),
        STONE("STONE", 1, 1, 131, 4.0F, 1.0F, 5),
        IRON("IRON", 2, 2, 250, 6.0F, 2F, 14),
        EMERALD("EMERALD", 3, 3, 950, 8.0F, 4.0F, 10), 
        GOLD("GOLD", 4, 0, 32, 12.0F, 1.69F, 22),
        
        /*
         *  0F = 4 attack damage
         *  1F = 5 attack damage
         *  2F = 6 attack damage
         *  le reste t pas con tu comprend tout seul
         *  
         */
        
      MANGANESE("MANGANESE", 5, 3, 1200, 14.0F, 3.5F, 10),
        GARNET(     "GARNET",6, 3, 1500, 10.0F, 4.5F, 10), // 10
        AMETHYST("AMETHYST", 7, 3, 2000, 13.0F, 6.0F, 10), // 10
        TITANIUM("TITANIUM", 8, 3, 2499, 16.0F, 7.0F, 10), // 12
        OBSIDIUM("OBSIDIUM", 10, 3, 3502, 18.0F, 8.0F, 5), // 13 attack damage
        
        
        
        //OBSIDIAN("OBSIDIAN", 9, 3, 4250, 14.0F, 7.0F, 10), // 11
        //  XENOTIUM("XENOTIUM", 10, 3, 3800, 17.0F, 9.0F, 5), // 13
        ;
        ...
        {
            return (Item) (this == WOOD ? Item.getItemFromBlock(Blocks.planks) : 
            		...
            		(this == GOLD ? Items.gold_ingot : 
            			(this == IRON ? Items.iron_ingot : 
            				(this == EMERALD ? Items.diamond : 
                				this == AMETHYST ?  Items.amethyst:
                    				this == GARNET ? Items.garnet :
                        				this == TITANIUM ? Items.titanium :
                            				//this == XENOTIUM ? Items.xenotium :
                            					this == MANGANESE ? Items.manganese :
            					null)))));
        }
    }
}